<template>
  <div class="run-map-view">
    ...
    <div class="run-map-header">
      <p class="run-map-hint">{{ headerText }}</p>
    </div>

    <!-- Legende -->
    <div class="run-map-legend">
      <span class="legend-item"><span class="field-icon start">💎</span> Start</span>
      <span class="legend-item"><span class="field-icon heal">🧪</span> Heilung</span>
      <span class="legend-item"><span class="field-icon fight">💀</span> Kampf</span>
      <span class="legend-item"><span class="field-icon boss">👑</span> Boss</span>
      <span class="legend-item"><span class="field-icon normal">⬜</span> Normal</span>
    </div>
...
const CELL_W = 8;  // Abstand horizontal zwischen Feldern
const CELL_H = 5;  // Abstand vertikal zwischen Feldern
const PADDING = 3;
...
function fieldFill(field) {
  ...
  switch (field.type) {
    ...
    case 'HEAL':   return '#dcfce7';
    case 'FIGHT':  return '#fee2e2';
    case 'BOSS':   return '#fef3c7';
